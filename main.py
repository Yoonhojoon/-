...
def process_image(image_file: str, number: str):
    ...
    background = Image.open("./uploads/frame.png").convert('RGB') # JPG는 투명도 없음, RGB로 변환
    ...
    font = ImageFont.truetype("./uploads/DepartureMono-Regular.otf", 94)  # Departure Mono 폰트 사용

    bbox = draw.textbbox((0, 0), text, font=font)
    text_width, text_height = bbox[2] - bbox[0], bbox[3] - bbox[1]
    position = ((img_size[0] - text_width) // 2, 940)
    ...
    position_date = ((img_size[0] - date_width) // 2, 1227)
